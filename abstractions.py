...
def make_location(latitude, longitude):
    """Return a location data abstraction containing latitude and longitude."""
    return [latitude, longitude]

def location_latitude(location):
    """Return the latitude of a location, which is a number."""
    return location[0]

def location_longitude(location):
    """Return the longitude of a location, which is a number."""
    return location[1]
